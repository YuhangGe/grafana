define([
  ...
  function (sdk, _, kbn, TimeSeries, rendering, legend) {
    var MetricsPanelCtrl = sdk.MetricsPanelCtrl;
    ...
    class PieChartCtrl extends MetricsPanelCtrl {
      ...
      onDataReceived(dataList) {
        ...
        for (var i = 0; i < this.series.length; i++) {
          this.data.push({
            label: this.series[i].alias,
            data: this.series[i].stats.current,
            color: this.$rootScope.colors[i]
          });
        }
    ...
    PieChartCtrl.templateUrl = 'public/app/plugins/panel/piechart/module.html';
